...
<head>
    ...
    <title>Contrato de Préstamo Personal con Fiador</title>
    <style>
        body {
...
<body>
    ...
    <p style="margin-top: 10px;">
        @if ($contract->client_type == 'Personal')
            ...
            MUTUATARIO / CLIENTE.
        @else
            ____________________________________ con DNI N° _________, con domicilio en __________ distrito de ______,
            Provincia de ______________, Departamento de Piura, en su condición de EL MUTUATARIO / CLIENTE.
        @endif
    </p>

    <p>________________, identificado con D.N.I. Nº _________ de estado civil ________ y con domicilio en
        _____________, provincia de _________, Departamento de ________; a quien en lo sucesivo se denominará EL (LOS)
        FIADOR(ES) Y/O AVAL(ES); en los términos contenidos en las cláusulas siguientes:</p>
    ...
    <p>EL MUTUATARIO / CLIENTE para continuar con el ejercicio de su actividad económica, requiere contar con un mutuo
        dinerario, por la suma de S/ {{ $amount }} ({{ $requestedInWords }}
        soles), monto que es de libre disposición del EL MUTUATARIO / CLIENTE.</p>
    ...
    <p>Las partes acuerdan que el presente contrato de mutuo se celebra a titulo oneroso, en consecuencia el mutuatario
        se obliga al pago de un interés de 15% mensual a favor de <span
            class="empresa">APLICANDO CONFIANZA PERU
    ...
    <p><strong>SÉTIMA.-</strong> En respaldo de las obligaciones asumidas, frente a <span class="empresa">APLICANDO
            CONFIANZA PERU S.A.C</span>, EL MUTUATARIO/ CLIENTE, suscribe pagare N°
        {{ $contract->number_pagare ?? '______________' }} emitido en
    ...
    <p><strong>OCTAVA.-</strong> EL (LOS) FIADOR(ES) Y/O AVAL(ES) que intervienen en el presente contrato, nos
        constituimos en FIADOR(ES) SOLIDARIO(S) de EL CLIENTE en forma solidaria, irrevocable, incondicional, ilimitada
        e indefinida renunciando expresamente al beneficio de excusión de división, así como a la facultad establecida
        en el artículo 1899° del Código Civil, obligándonos a pagar todas las obligaciones derivadas del otorgamiento
        del o los créditos que contraiga EL CLIENTE en ejecución del presente contrato, presentes o futuras, directas o
        acreditado en cualquier título ejecutivo. Se precisa que el fiador garantiza en forma total, todas y cada una de
        las obligaciones que asume EL CLIENTE en virtud a este contrato.</p>

    <p><strong>NOVENA.-</strong> En lo no previsto por las partes en el presente contrato, ambas se someten a lo
    ...
    <p style="margin-top: 10px;">En señal de conformidad las partes suscriben este documento en la ciudad de Piura, el
        ...
        {{ $contract->date ? $contract->date->format('Y') : '2025' }}.</p>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="width: 50%; text-align: center; border: none; padding: 0;">
                    <div style="border-top: 2px solid #000; width: 150px; margin: 0 auto; padding-top: 10px;">
                        <p><strong>FIADOR / AVAL</strong></p>
                    </div>
                </td>
                <td style="width: 50%; text-align: center; border: none; padding: 0;">
                    <div style="border-top: 2px solid #000; width: 150px; margin: 0 auto; padding-top: 10px;">
    ...
    <p style="margin-top: 20px;">
        ...
        {{ $contract->quotas && count($contract->quotas) > 0 ? $contract->quotas->last()->date->format('d/m/Y') : '________________' }}
    </p>
    ...
    <p>El obligado principal y el/los aval/es, permanentes acepta igualmente que las tasas de interés compensatorio y/o
        moratorio puedan ser variadas por la empresa <span class="empresa">APLICANDO CONFIANZA PERU S.A.C</span> y /o
        su ultimo tenedor sin necesidad de aviso previo, de acuerdo a las tasas que ésta tenga vigente.</p>
    ...
    <p><strong>5.</strong> De conformidad con el Articulo 52 de la ley N° 27287, queda expresamente establecido que el
        ...
        costo de tales protestos, pudiendo trasladar dicho costo al obligado principal y/los obligados solidarios según
        sea el caso.</p>
    ...
    <p style="margin-top: 15px;">En los mismos términos, y calidad antes expresados, que declaro haber leído en su
        integridad, encontrando conforme y aceptados en todos su extremos, interviene en este PAGARE, en igual calidad
        del obligado principal, el (los) AVAL(ES) y el del cónyuge del AVAL, conforme al articulo 292 y 315 del código
        civil, garantizando el pago presente pagare y de todas las obligaciones que represente este documento,
        comprometiéndome(nos) a responder y pagar la cantidad adeudada, sus interés compensatorios y moratorios, de ser
        el caso y demás aplicables, gastos notariales y de cobranza prejudicial, extrajudicial o judicial, que se
        pudieran devengar desde la fecha de emisión hasta la cancelación total de la presente obligación.</p>

    <p>Esta garantía es solidaria, irrevocable, incondicional, de realización automática, sin beneficio de excusión,
        indeterminada e ilimitada, de plazo indefinido y estará vigente mientras no se encuentre(n) totalmente pagada(s)
        las obligación(es) que represente el presente pagaré, aceptando desde ahora, la(s) prórroga(s) que <span
            class="empresa">APLICANDO CONFIANZA PERU S.A.C</span> conceda al obligado principal, para lo cual
        presto(amos) mi (nuestro) expreso consentimiento, sin que sea necesaria mi (nuestra) intervención y
        suscripción.</p>

    <p>Acepto(amos), de conformidad con lo establecido por el Artículo 52 de la Ley N° 27287, que el presente Pagaré no
        requiere ser protestado; sin embargo, <span class="empresa">APLICANDO CONFIANZA PERU S.A.C</span> queda
        facultado a protestarlo por falta de pago si así lo estimare conveniente, cuyos costos de tal protesto, son
        asumidos y/o trasladados al obligado u obligados solidarios, según sea el caso.</p>
        ...
        <table style="width: 100%; border-collapse: collapse;">
            <tr>
                <td style="width: 50%; border: none; padding: 0; vertical-align: top;">
                    ...
                    <p style="margin: 2px 0; font-weight: bold; font-size: 9pt;">FIRMA DE AVAL</p>
                    <p style="font-size: 8pt; text-align: left; margin: 2px 0; line-height: 1.4;">
                        Nombre:………………………………………<br>
                        DNI N°: ……………………………………<br>
                        Estado Civil………………………………<br>
                ...
                <td style="width: 50%; border: none; padding: 0; vertical-align: top;">
                    ...
                    <p style="margin: 2px 0; font-weight: bold; font-size: 9pt;">FIRMA DEL CONYUGE DEL AVAL</p>
                    <p style="font-size: 8pt; text-align: left; margin: 2px 0; line-height: 1.4;">
                        Nombre:………………………………………<br>
                        DNI N°:……………………………………<br>
                        Estado Civil:……………………………<br>
